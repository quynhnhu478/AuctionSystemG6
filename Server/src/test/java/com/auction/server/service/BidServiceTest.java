...
public class BidServiceTest{
    ...
    void registerAutoBid_WhenMaxBidLessThanMinimum(){
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            bidService.registerAutoBid(auction.getId(), bidderA.getID(), 540.0,60.0);
        });
    ...
    void registerAutoBid_WhenBalanceInsufficient(){
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            bidService.registerAutoBid(auction.getId(), bidderA.getID(), 1500.0,77.0);
        });
    ...
    void autoBidCompetition_TwoRobotsBiddingWar(){
        ...
        bidService.registerAutoBid(auction.getId(), bidderA.getId(), 800.0,88.0);
        ...
        AuctionUpdateResponse response = bidService.registerAutoBid(auction.getId(), bidderB.getId(), 1200.0,200.0);
    ...
    void manualBid_TriggersAutoBidResponse(){
        ...
        bidService.registerAutoBid(auction.getId(), bidderB.getId(), 1500.0,70.0);
